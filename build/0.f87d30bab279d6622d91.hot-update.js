...
var App = function (_Component) {
  ...
  _createClass(App, [{
    ...
    value: function clickLoginButton(user, pass) {
      //AJAX call
      this.setState({ page_state: "createAccount", username: user });
    }
  }, {
    key: 'createAccount',
    ...
    value: function render() {
      ...
      if (this.state.page_state === "login") return _react2.default.createElement(_Login2.default, { clickLoginButton: this.clickLoginButton.bind(this) });else if (this.state.page_state === "createAccount") return _react2.default.createElement(_CreateAccount2.default, { clickSubmit: this.createAccount.bind(this) });else if (this.state.page_state === "main") return _react2.default.createElement(_Main2.default, { username: this.state.username });
    }
  }]);
