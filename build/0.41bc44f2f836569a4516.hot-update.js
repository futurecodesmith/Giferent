...
var CreateAccount = function (_Component) {
  ...
  _createClass(CreateAccount, [{
    ...
    value: function render() {
      ...
      if (this.state.password === this.state.verifyPassword) passwordError = [];else passwordsError = [_react2.default.createElement(
        'span',
        { style: { "color": "red" } },
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement('input', { type: 'text', value: this.state.username, onChange: this.userNameHandler_BOUND }),
        _react2.default.createElement('br', null),
        _react2.default.createElement('input', { type: 'text', value: this.state.password, onChange: this.passwordHandler_BOUND }),
        _react2.default.createElement('br', null),
        _react2.default.createElement('input', { type: 'text', value: this.state.verifyPassword, onChange: this.verifyPasswordHandler_BOUND }),
        _react2.default.createElement('br', null),
        passwordError
      );
    }
